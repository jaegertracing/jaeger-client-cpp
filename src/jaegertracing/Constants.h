...
static constexpr auto kTraceContextHeaderName = "x-b3-id";
...
static constexpr auto kzipkinTraceIdHeaderName = "x-b3-trace-id";
static constexpr auto kzipkinParentSpanIdHeaderName="x-b3-parent-span-id";
static constexpr auto kzipkinSpanIdHeaderName="x-b3-span-id";
