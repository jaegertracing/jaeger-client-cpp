...
Because exactly Thrift 0.9.2 is required, you'll likely need to
...
or too new; cpp-client requires exactly 0.9.2.
...
generation. It currently requires exactly Thrift 0.9.2. Patches have
